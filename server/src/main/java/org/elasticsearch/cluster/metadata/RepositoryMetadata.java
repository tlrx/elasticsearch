...
public class RepositoryMetadata implements Writeable {
    ...
    /**
     * Returns the list of snapshots from this repository that have been marked as deletion after a searchable snapshot index with the
    ...
    public boolean equals(Object o) {
        ...
        return snapshotsToDelete.equals(that.snapshotsToDelete);
    }
