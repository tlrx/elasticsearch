...
public class AutoRestoreWithRecoverySourceProvidersIT extends AutoRestoreIntegTestCase {
    ...
    public static class TestPlugin extends AutoRestoreTestPlugin implements ClusterPlugin {
