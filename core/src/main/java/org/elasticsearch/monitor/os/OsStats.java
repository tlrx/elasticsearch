...
public class OsStats implements Writeable, ToXContentFragment {
    ...
    public static class Swap implements Writeable, ToXContentFragment {
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            ...
            builder.field(Fields.TOTAL_IN_BYTES, Fields.TOTAL, getTotal());
            builder.field(Fields.FREE_IN_BYTES, Fields.FREE, getFree());
            builder.field(Fields.USED_IN_BYTES, Fields.USED, getUsed());
            builder.endObject();
            return builder;
        }
    }
