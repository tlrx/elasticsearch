...
public class FrozenSearchableSnapshotsIntegTests extends BaseFrozenSearchableSnapshotsIntegTestCase {
    ...
    public void testRequestCacheOnFrozen() throws Exception {
        ...
        indexRandom(
            true,
            client().prepareIndex("test-index", "_doc").setSource("f", "2014-03-10T00:00:00.000Z"),
            client().prepareIndex("test-index", "_doc").setSource("f", "2014-05-13T00:00:00.000Z")
        );
